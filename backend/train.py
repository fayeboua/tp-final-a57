...
def train(experiment_name, target, models):
    ...
    with mlflow.start_run() as run:
        ...
        mlflow.log_artifact('data/processed/train.csv', artifact_path="input_data")
        mlflow.log_artifact('data/processed/train_col_types.json', artifact_path="input_data")

        aml = H2OAutoML(
                        max_models=models, # Run AutoML for n base models
                        seed=42, 
